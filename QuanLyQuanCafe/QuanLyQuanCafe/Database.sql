USE [master]
GO
/****** Object:  Database [QuanLiQuanCafe]    Script Date: 12/14/2018 3:42:54 PM ******/
CREATE DATABASE [QuanLiQuanCafe]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'QuanLiQuanCafe', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\QuanLiQuanCafe.mdf' , SIZE = 3136KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'QuanLiQuanCafe_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\QuanLiQuanCafe_log.ldf' , SIZE = 832KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
ALTER DATABASE [QuanLiQuanCafe] SET COMPATIBILITY_LEVEL = 110
GO
...
GO
ALTER DATABASE [QuanLiQuanCafe] SET AUTO_CREATE_STATISTICS ON 
GO
...
GO
ALTER DATABASE [QuanLiQuanCafe] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
USE [QuanLiQuanCafe]
GO
/****** Object:  Table [dbo].[DanhSachNuocUong]    Script Date: 12/14/2018 3:42:54 PM ******/
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[DanhSachNuocUong](
...
GO
/****** Object:  Table [dbo].[HOADON]    Script Date: 12/14/2018 3:42:54 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
